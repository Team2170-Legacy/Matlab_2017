...
axis('square')					% ensure x & y directions are scale equally on screen
xlim([-1 5])					% [m]	set figure limits for x-axis
ylim([-2 4])					% [m]	set figure limits for y-axis
...
Period			= tfinal / 4;		% period & frequency for example wheel velocity sine-waves
freq			= 1/Period;
