...
Robot.v_max = 1.0;      % Robot max velocity (on each R / L drive wheel)
...
Ts          = 0.010;
[all_omega_R, all_omega_L, all_t] = calc_trajectory_v3(x0,y0,theta0,xf,yf,thetaf,vx0,vy0,omega0,vxf,vyf,omegaf, Robot, Ts);
