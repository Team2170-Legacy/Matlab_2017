...
AirshipRed.distfromwall = 114.3*in;
AirshipRed.flattoflat = 70.59*in;
AirshipRed.cornertocorner = 80.07*in;

%*** OLD WRONG AirShipRed.x = -488.0333*in + 55*ft;
...
AirShipRed.R        = AirshipRed.cornertocorner / 2;
...
RP1.Peg_L   = 10.5*in;
RP1.th      = 120*deg;
RP1.C2_x    = RP1.C1_x + RP1.Peg_L * cos(RP1.th);
RP1.C2_y    = RP1.C1_y + RP1.Peg_L * sin(RP1.th);

RP2.Peg_L   = 10.5*in;
RP2.th      = 180*deg;
RP2.C2_x    = RP2.C1_x + RP2.Peg_L * cos(RP2.th);
RP2.C2_y    = RP2.C1_y + RP2.Peg_L * sin(RP2.th);

RP3.Peg_L   = 10.5*in;
RP3.th      = 240*deg;
RP3.C2_x    = RP3.C1_x + RP3.Peg_L * cos(RP3.th);
RP3.C2_y    = RP3.C1_y + RP3.Peg_L * sin(RP3.th);
...
%   To calculate Blue Airship peg locations,
%   Mirror all Red peg x-locations in field center line
...
Field.RS3.y		= Field.BoilerRed.C1_y + (Robot.W/2);                % [m]	Robot center starting position along y-axis
...
Field.RS1.y		= Field.W - (41.5*in + (Robot.W/2));                % [m]	Robot center starting position along y-axis
