...
start_pos   = 'RP1';    end_pos     = 'RH';


[all_omega_R, all_omega_L, all_t,t_auto_end, i_auto_end] = calc_trajectory_v9(start_pos,end_pos,vx0,vy0,omega0,vxf,vyf,omegaf, Robot, Field, Ts);
