...
Robot.Start_Pos     = Field.RP1;    % CHANGE SPECIFIED STARTING POSITION HERE
                                    % OR
...
P0          = [P0_x P0_y];
theta1_0    = theta0;
rel_theta1  = +150*deg;      % [rad] robot turn angle in segment 1
theta1_f	= theta1_0 + rel_theta1;

arcR        = 1.2;          % [m]   Arc radius
...
C1_x			= x0 + arcR * cos(210*deg);
C1_y			= y0 + arcR * sin(210*deg);
...
sweep_angle_t3     = all_theta_t3 - 270*deg;
