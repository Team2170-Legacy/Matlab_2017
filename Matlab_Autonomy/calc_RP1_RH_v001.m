...
%%--------------------------------------------------------------------------
%
%   Trajectory Type : From  Peg RP3 TO Red Hopper
%
...
Robot.Start_Pos.theta = 120*deg;

P0.x        = Peg.C1_x + Robot.L/2*cos(Robot.Start_Pos.theta);
P0.y        = Peg.C1_y + Robot.L/2*sin(Robot.Start_Pos.theta);
P0.theta    = Robot.Start_Pos.theta;

Robot.Start_Pos.x     = P0.x;
Robot.Start_Pos.y     = P0.y;
% CHANGE SPECIFIED STARTING POSITION HERE
                                    % OR
...
all_theta_t1    = theta1_0 + rel_theta1.* all_t1 ./ t1;
...
sweep_angle_t2	= all_theta_t2-90*deg;
